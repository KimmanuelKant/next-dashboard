...
const defaultColumns = [
  ...
  { header: "GK Points", accessorKey: "totalGKPoints" },
  { header: "DEF Points", accessorKey: "totalDEFPoints" },
  { header: "MID Points", accessorKey: "totalMIDPoints" },
  { header: "FWD Points", accessorKey: "totalFWDPoints" },
];
